...
public class Cinema extends JFrame implements ItemListener {
    ...
    private final JLabel selectedSeatLabel2 = new JLabel("", JLabel.CENTER);
...
//    private final int HEIGHT = 20;
    ...
    public Cinema(String cinemaName, int numRows, int seatsPerRow) {
        ...
        selectedSeatLabel2.setBounds(TOP_X, (screen.getHeight() + TOP_Y + 2 * H_SPACE + selectedSeatLabel.getHeight()), 100, 20 );
        add(selectedSeatLabel2);
        add(yourSelection);
        add(screen);
        add(panel);
